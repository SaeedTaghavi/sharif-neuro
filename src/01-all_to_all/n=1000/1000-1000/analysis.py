...
plt.hist(theta0,np.linspace(0.,2.*pi,360),bottom=10)
plt.xticks([])
plt.yticks([])
plt.axis('off')
plt.grid(False)
...
plt.subplot(111,polar=True)
#plt.subplot(111)
plt.hist(theta_vasat,np.linspace(0.,2.*pi,360),bottom=10)
plt.xticks([])
plt.yticks([])
plt.axis('off')
plt.grid(False)
...
plt.figure(5)
plt.subplot(111,polar=True)
plt.hist(theta_last,np.linspace(0.,2.*pi,360),bottom=10)
